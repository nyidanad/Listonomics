  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      <ScrollView style={styles.container}>
        ...
        <View style={[styles.section, { backgroundColor: theme.list }]}>
        ...
        <View style={[styles.section, { marginTop: 12, backgroundColor: theme.list }]}>
        ...
        <View style={[styles.section, { marginVertical: 12, backgroundColor: theme.list }]}>
          <UnregisterButton />
        </View>
      </ScrollView>
    </SafeAreaView>
