...
const itemEditModal = ({ item, showModal, setShowModal, listId }: itemEditModalProps) => {
  ...
  const updateItem = async () => {
    try {
      ...
      if (error) {
        throw Error('Item update failed ', error)
      }

      console.log('[EDIT] Item updated successfully.')
      onClose()
    } catch (err) {
      console.log('Item update failed:', err)
    }
  }
